...
class Help(commands.Cog):
    ...
    async def help(self, ctx, cmd=None):
        ...
        embed.add_field(name=":loud_sound: **Music**", value="`play`,`pause`,`leave`,`resume`,`remove`,`queue`,`join`,`skip`,`search`,`loop`", inline=False)
        embed.add_field(name=":shield: **Mod**", value="`kick`,`ban`,`purge`,`unban`,`announce`,`changeprefix`", inline=False)
        ...
        embed.add_field(name=":hugging: **Actions**", value="`cuddle`,`feed`,`hug`,`kickk`,`kiss`,`pat`,`punch`,`slap`,`poke`,`dance`,`squeeze`,`handholding`,`bite`", inline=False)
        embed.add_field(name=":newspaper: **News**", value="Music commands have been fixed.", inline=False)
